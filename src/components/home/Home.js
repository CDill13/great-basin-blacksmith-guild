    ...
    return (
        <div className="home1Div">
            ...
            <div className="homeText">
                ...
                <div className="blackBottomeLine"></div>
                <h2>HISTORICAL DEMONSTRATIONS WITH MICHEAL MENDENHALL</h2>
                <h3>MONDAY JULY 2ND  5:00 PM -8:00 PM AT SCERA PARK AT 600 SOUTH STATE STREET OREM UTAH.</h3>
                ...
                <h3>SATURDAY JULY 21ST 9:00 AM, 7212 WEST 900 SOUTH, OGDEN UTAH</h3>
                ...
                <br/>
                <br/>
                <iframe title="Pillow Forging" width="500" height="300" src="https://www.youtube.com/embed/mZKdXuGfjMI" frameBorder="0" allow="autoplay; encrypted-media" allowFullScreen></iframe>
                <br/>
                <br/>
            ...
            <br/>
            <br/>            
            <p className="homeDesc" >The Great Basin Blacksmith Guild is a blacksmithing group for those in Utah and surrounding states that are interested in learning more about the craft of blacksmithing. Meetings are held every other month of the year in various locations throughout Utah. We welcome new and experienced smiths to our group.</p>
            <br/>
            <br/>
